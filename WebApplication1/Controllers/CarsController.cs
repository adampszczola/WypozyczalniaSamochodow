...
namespace WebApplication1.Controllers
{
    public class CarsController : Controller
    {
        ...
        //Dodanie akcji zczytywania pojazdow do listy zwiazanej z kategoria
        ...
        //tworzymy metode zwracajaca widok czastkowy
        //(mozna go stworzyc PPM na nazwie metody -> Add View (zaznaczyc checkbox partial view)
        //trzeba pamietac o wywolaniu akcji w headerze w Layout
